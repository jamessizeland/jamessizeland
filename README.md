<img style="position: relative; z-index: -1" src="./img/tail.png"></img>
...
<table>
<tr>
<td><img style="width: 90px" src="./img/rust.svg" alt="Rust icon" /></td>
<td><img style="width: 90px" src="./img/ts.svg" alt="Typescript icon" /></td>
<td><img style="width: 90px" src="./img/react.svg" alt="React icon" /></td>
<td><img style="width: 90px" src="./img/nodejs.svg" alt="Node.js icon" /></td>
<td><img style="width: 90px" src="./img/labview.svg" alt="LabVIEW icon" /></td>
</tr>
</table>
...
<div align="center">
<img alt="unit cells" src="./img/unit-cells.png"/>
<br/>
<br/>
